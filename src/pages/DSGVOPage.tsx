...
export function FirstPage() {
    ...
    return <div>
        ...
        <p>
            ...
            Johannes Kepler Universität Linz (JKU), Altenberger Straße 69, 4040 Linz, datenschutz@jku.at. Bei Fragen zur
            Studie, wenden Sie sich bitte an [Name des Verantwortlichen], Johannes Kepler Universität Linz,
            Altenberger Straße 69, 4040 Linz, [Email-Adresse des Verantwortlichen] oder [Email-Adresse des Instituts].
        </p>
        <p>
            Wenn Sie mehr Information über die Verarbeitung Ihrer personenbezogenen Daten wünschen, <i>bitte hier klicken</i>.
        </p>
        ...
        <br />
        <p>
            Und unter hier klicken kamen dann noch folgende Infos:
        </p>
        <b>
        ...
        <p>
            ...
            Daten im Internet in einem Datenarchiv zugänglich gemacht werden. Damit folgt diese Studie den Empfehlungen der Deutschen
            Forschungsgesellschaft (DFG) und der Deutschen Gesellschaft für Psychologie (DGPs) zur Qualitätssicherung in der Forschung.
        </p>
        ...
        <p>
            Unmittelbar personenbezogene oder personenbeziehbare Daten, die Rückschlüsse auf Ihre Identität zulassen, werden nicht erfasst.
        </p>
        <b>
        ...
        <b>
            Datenübermittilung in ein Land ausserhalb der EU/EWR oder an eine international Organisation, und Datenübermittlung vorbehaltlich
            geeigneter Garantien
        </b>
        <p>
            Die anonymisierten Daten werden dem Auftraggeber der Studie oder einer von dieser beauftragten Stelle zu wissenschaftlichen
            Zwecken oder zum Zwecke der Universitären Lehre zur Verfügung gestellt. Die anonymisierten Daten können im Zuge internationaler
        ...
        <p>
            ...
            bei der österreichischen Datenschutzbehörde, Barichgasse 40-42, 1030 Wien, Tel.: + 43 1 52 152-0, E-Mail: dsb@dsb.gv.at
            beschweren.
        </p>
        <b>
        ...
        <p>
            Der Datenschutzbeauftragte im Sinne des Art 37 DSGVO ist erreichbar unter Johannes Kepler Universität Linz (JKU), Stabstelle Datenschutz, Altenberger Straße 69, 4040 Linz, datenschutz@jku.at.<p> </p>
        </p>
    </div>
}