...
export function WelcomePage() {
	return <div>
		...
		<h4>Procedure</h4>
		<ul>
			<li>In this survey you will be given 8 questions which can be answered by using the implemented dashboard.</li>
			<li>
				The possible answers will be shown as soon as you click the "Ready to answer"-button.
				After clicking this button it is not possible to interact with the dashboard anymore for the given question.
			</li>
			<li>After each question you will be asked to weight the complexity of the task.</li>
			<li>When you are done with all tasks, there will then be an evaluation of the usability of the tool.</li>
